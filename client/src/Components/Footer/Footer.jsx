...
export const Footer = () => {
  return (
    <>
       ...
       <div className="left-div">
            <div className="footer-logo">
                {/* <img src="Images/CredgrowLogo.png" alt="logo" width="100%" height="100%"/> */}
            </div>
            ...
            <div className="Email-div">
                ...
                <button className="Email-button"><img src="/Images/Emailimg.png" alt="Email-button" width="100%" height="100%"/></button>
            </div>
    </div>
    ...
    <div className="right-div">
     ...
     <div className="part2">
        <p className="foot-t4"> © All Rights Reserved 2024</p>
